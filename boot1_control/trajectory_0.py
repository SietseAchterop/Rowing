...
def main():
    ...
    if reset:
        ...
        """
        arm_goals  = [[0.8, -0.8, 0.0, 0.0, 0.02, -0.01],
                      [0.8, -0.8, 0.15, 0.0 , 0.02, -0.01],
                      [0.8, -0.8, 0.0, 0.0, 0.02, -0.01],
                      [0.8, -0.8, -0.15, 0.0 , 0.02, -0.01],
                      [0.8, -0.8, 0.0, 0.0, 0.02, -0.01],
                      [0.8, -0.8, -0.15, 0.0 , 0.02, -0.01],
                      [0.8, -0.8, 0.0, 0.0, 0.02, -0.01],
        ...
        arm_goals  = [[0.0, -0.0, -0.0, 0.0, 0.4, -0.4],
                      [0.0, -0.0, -0.0, 0.0, -0.4, 0.4],
                      [0.0, -0.0, -0.0, 0.0, -0.02, -0.01],
                      [0.0, -0.0, -0.18, 0.18, -0.02, -0.01],
        ]
        """
