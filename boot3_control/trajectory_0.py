...
def main():
    ...
    #os.system("gz model -m boot -d; roslaunch boot3_control param.launch; sleep 1; rosrun gazebo_ros spawn_model -model boot -urdf -param robot_description")
